...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.user_school_level'
        db.add_column('auth_userprofile', 'user_school_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.user_school_level'
        db.delete_column('auth_userprofile', 'user_school_level')
