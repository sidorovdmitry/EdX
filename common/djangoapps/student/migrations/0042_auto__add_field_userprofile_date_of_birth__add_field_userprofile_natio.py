...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auth_userprofile', 'nationality',
                      self.gf('django_countries.fields.CountryField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.unique_id'
        db.add_column('auth_userprofile', 'unique_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('auth_userprofile', 'nationality')

        # Deleting field 'UserProfile.unique_id'
        db.delete_column('auth_userprofile', 'unique_id')
