...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabKeyword.frequency'
        db.add_column('labster_search_labkeyword', 'frequency',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabKeyword.frequency'
        db.delete_column('labster_search_labkeyword', 'frequency')
