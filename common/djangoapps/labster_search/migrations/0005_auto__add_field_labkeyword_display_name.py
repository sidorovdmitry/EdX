...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabKeyword.display_name'
        db.add_column('labster_search_labkeyword', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabKeyword.display_name'
        db.delete_column('labster_search_labkeyword', 'display_name')
