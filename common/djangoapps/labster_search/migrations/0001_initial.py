...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LabKeyword'
        db.create_table('labster_search_labkeyword', (
            ...
            ('keyword_type', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('labster_search', ['LabKeyword'])

        # Adding unique constraint on 'LabKeyword', fields ['lab', 'keyword', 'keyword_type']
        db.create_unique('labster_search_labkeyword', ['lab_id', 'keyword', 'keyword_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'LabKeyword', fields ['lab', 'keyword', 'keyword_type']
        db.delete_unique('labster_search_labkeyword', ['lab_id', 'keyword', 'keyword_type'])

        # Deleting model 'LabKeyword'
        db.delete_table('labster_search_labkeyword')
