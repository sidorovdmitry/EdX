...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabKeyword.created_at'
        db.add_column('labster_search_labkeyword', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'LabKeyword.modified_at'
        db.add_column('labster_search_labkeyword', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabKeyword.created_at'
        db.delete_column('labster_search_labkeyword', 'created_at')

        # Deleting field 'LabKeyword.modified_at'
        db.delete_column('labster_search_labkeyword', 'modified_at')
