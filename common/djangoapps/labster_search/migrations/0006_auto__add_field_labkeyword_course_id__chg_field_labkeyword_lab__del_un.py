...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LabKeyword', fields ['keyword_type', 'keyword', 'lab']
        db.delete_unique('labster_search_labkeyword', ['keyword_type', 'keyword', 'lab_id'])

        # Adding field 'LabKeyword.course_id'
        db.add_column('labster_search_labkeyword', 'course_id',
                      self.gf('xmodule_django.models.CourseKeyField')(db_index=True, max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'LabKeyword.lab'
        db.alter_column('labster_search_labkeyword', 'lab_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.Lab'], null=True))

    def backwards(self, orm):
        # Deleting field 'LabKeyword.course_id'
        db.delete_column('labster_search_labkeyword', 'course_id')


        # Changing field 'LabKeyword.lab'
        db.alter_column('labster_search_labkeyword', 'lab_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['labster.Lab']))
        # Adding unique constraint on 'LabKeyword', fields ['keyword_type', 'keyword', 'lab']
        db.create_unique('labster_search_labkeyword', ['keyword_type', 'keyword', 'lab_id'])
    ...
    models = {
        ...
        'labster_search.labkeyword': {
            'Meta': {'object_name': 'LabKeyword'},
            'course_id': ('xmodule_django.models.CourseKeyField', [], {'db_index': 'True', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'display_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'frequency': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
