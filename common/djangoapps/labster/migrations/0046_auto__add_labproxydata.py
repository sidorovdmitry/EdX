...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LabProxyData'
        db.create_table('labster_labproxydata', (
        ...
        db.send_create_signal('labster', ['LabProxyData'])


    def backwards(self, orm):
        # Deleting model 'LabProxyData'
        db.delete_table('labster_labproxydata')
