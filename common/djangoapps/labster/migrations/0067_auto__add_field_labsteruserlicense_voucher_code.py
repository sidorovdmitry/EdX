...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabsterUserLicense.voucher_code'
        db.add_column('labster_labsteruserlicense', 'voucher_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabsterUserLicense.voucher_code'
        db.delete_column('labster_labsteruserlicense', 'voucher_code')
