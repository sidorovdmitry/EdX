...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAttempt.is_completed'
        db.add_column('labster_userattempt', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserAttempt.completed_at'
        db.add_column('labster_userattempt', 'completed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAttempt.is_completed'
        db.delete_column('labster_userattempt', 'is_completed')

        # Deleting field 'UserAttempt.completed_at'
        db.delete_column('labster_userattempt', 'completed_at')
