...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.xml_url_prefix'
        db.add_column('labster_lab', 'xml_url_prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.xml_url_prefix'
        db.delete_column('labster_lab', 'xml_url_prefix')
    ...
    models = {
        ...
        'labster.lab': {
            ...
            'xml_url_prefix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'})
        },
        'labster.labproxy': {
