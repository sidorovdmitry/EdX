...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LabsterUser.ip_number'
        db.delete_column('labster_labsteruser', 'ip_number')

        # Adding field 'LabsterUser.ip_address'
        db.add_column('labster_labsteruser', 'ip_address',
                      self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LabsterUser.ip_number'
        db.add_column('labster_labsteruser', 'ip_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'LabsterUser.ip_address'
        db.delete_column('labster_labsteruser', 'ip_address')
