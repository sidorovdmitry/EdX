...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'QuizBlock', fields ['lab', 'element_id']
        db.create_unique('labster_quizblock', ['lab_id', 'element_id'])

        # Adding model 'Answer'
        db.create_table('labster_answer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('problem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.Problem'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('hashed_text', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('is_correct', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('labster', ['Answer'])

        # Adding unique constraint on 'Answer', fields ['problem', 'hashed_text']
        db.create_unique('labster_answer', ['problem_id', 'hashed_text'])
        ...
        db.create_table('labster_problem', (
            ...
            ('correct_message', self.gf('django.db.models.fields.TextField')(default='')),
            ('wrong_message', self.gf('django.db.models.fields.TextField')(default='')),
            ('no_score', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('max_attempts', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('randomize_option_order', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('labster', ['Problem'])

        # Adding unique constraint on 'Problem', fields ['quiz_block', 'element_id']
        db.create_unique('labster_problem', ['quiz_block_id', 'element_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Problem', fields ['quiz_block', 'element_id']
        db.delete_unique('labster_problem', ['quiz_block_id', 'element_id'])

        # Removing unique constraint on 'Answer', fields ['problem', 'hashed_text']
        db.delete_unique('labster_answer', ['problem_id', 'hashed_text'])

        # Removing unique constraint on 'QuizBlock', fields ['lab', 'element_id']
        db.delete_unique('labster_quizblock', ['lab_id', 'element_id'])

        # Deleting model 'QuizBlock'
        db.delete_table('labster_quizblock')

        # Deleting model 'Answer'
        db.delete_table('labster_answer')
