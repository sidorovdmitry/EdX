...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabProxyData.score_file'
        db.add_column('labster_labproxydata', 'score_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabProxyData.score_file'
        db.delete_column('labster_labproxydata', 'score_file')
