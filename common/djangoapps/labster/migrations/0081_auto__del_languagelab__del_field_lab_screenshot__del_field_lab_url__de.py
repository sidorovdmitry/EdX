...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Lab.screenshot'
        db.delete_column('labster_lab', 'screenshot')

        # Deleting field 'Lab.url'
        db.delete_column('labster_lab', 'url')

        # Deleting field 'Lab.wiki_url'
        db.delete_column('labster_lab', 'wiki_url')
        ...
        db.delete_table(db.shorten_name('labster_lab_languages'))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Lab.screenshot'
        db.add_column('labster_lab', 'screenshot',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Lab.url'
        db.add_column('labster_lab', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=120, blank=True),
                      keep_default=False)

        # Adding field 'Lab.wiki_url'
        db.add_column('labster_lab', 'wiki_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=120, blank=True),
                      keep_default=False)
        ...
        m2m_table_name = db.shorten_name('labster_lab_languages')
        ...
        db.create_unique(m2m_table_name, ['lab_id', 'languagelab_id'])
