...
from labster.models import separate_tag_from_message
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for log in orm.UnityLog.objects.filter(log_type='UNITY_LOG'):
            tag, message = separate_tag_from_message(log.message)
            log.tag = tag
            log.message = message
            log.save()
    ...
    models = {
        ...
        'labster.unitylog': {
            ...
            'tag': ('django.db.models.fields.CharField', [], {'default': "'INFO'", 'max_length': '50'}),
