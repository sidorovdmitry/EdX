...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['labster.LabsterUser'].objects.all().update(is_email_active=True)
        for each in orm['labster.LabsterUser'].objects.all():
            each.email_activation_key = uuid.uuid4().hex
            each.save()
