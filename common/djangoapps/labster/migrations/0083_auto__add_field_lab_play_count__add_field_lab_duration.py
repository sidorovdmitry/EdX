...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.play_count'
        db.add_column('labster_lab', 'play_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Lab.duration'
        db.add_column('labster_lab', 'duration',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.play_count'
        db.delete_column('labster_lab', 'play_count')

        # Deleting field 'Lab.duration'
        db.delete_column('labster_lab', 'duration')
