...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemProxy.quiz_id'
        db.add_column('labster_problemproxy', 'quiz_id',
                      self.gf('django.db.models.fields.CharField')(default='UPDATE_THIS', max_length=100, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemProxy.quiz_id'
        db.delete_column('labster_problemproxy', 'quiz_id')
