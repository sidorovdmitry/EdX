...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.quiz_block_file'
        db.add_column('labster_lab', 'quiz_block_file',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.quiz_block_file'
        db.delete_column('labster_lab', 'quiz_block_file')
