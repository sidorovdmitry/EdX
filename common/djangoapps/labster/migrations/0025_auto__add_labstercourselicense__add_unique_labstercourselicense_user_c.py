...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LabsterCourseLicense'
        db.create_table('labster_labstercourselicense', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('course_id', self.gf('xmodule_django.models.CourseKeyField')(max_length=255, db_index=True)),
            ('license_id', self.gf('django.db.models.fields.IntegerField')(unique=True)),
        ))
        db.send_create_signal('labster', ['LabsterCourseLicense'])

        # Adding unique constraint on 'LabsterCourseLicense', fields ['user', 'course_id']
        db.create_unique('labster_labstercourselicense', ['user_id', 'course_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LabsterCourseLicense', fields ['user', 'course_id']
        db.delete_unique('labster_labstercourselicense', ['user_id', 'course_id'])

        # Deleting model 'LabsterCourseLicense'
        db.delete_table('labster_labstercourselicense')
