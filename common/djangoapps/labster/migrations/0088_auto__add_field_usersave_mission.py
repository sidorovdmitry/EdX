...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserSave.mission'
        db.add_column('labster_usersave', 'mission',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.Mission'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserSave.mission'
        db.delete_column('labster_usersave', 'mission_id')
