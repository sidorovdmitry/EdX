...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.direction_for_scoring'
        db.add_column('labster_problem', 'direction_for_scoring',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.direction_for_scoring'
        db.delete_column('labster_problem', 'direction_for_scoring')
