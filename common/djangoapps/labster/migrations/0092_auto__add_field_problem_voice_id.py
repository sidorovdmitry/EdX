...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.voice_id'
        db.add_column('labster_problem', 'voice_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.voice_id'
        db.delete_column('labster_problem', 'voice_id')
    ...
    models = {
        ...
        'labster.problem': {
            ...
            'voice_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
