...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabsterUser.is_email_active'
        db.add_column('labster_labsteruser', 'is_email_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabsterUser.is_email_active'
        db.delete_column('labster_labsteruser', 'is_email_active')
