...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabsterUser.email_activation_key'
        db.add_column('labster_labsteruser', 'email_activation_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabsterUser.email_activation_key'
        db.delete_column('labster_labsteruser', 'email_activation_key')
