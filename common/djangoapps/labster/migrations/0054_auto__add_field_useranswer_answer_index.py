...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAnswer.answer_index'
        db.add_column('labster_useranswer', 'answer_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAnswer.answer_index'
        db.delete_column('labster_useranswer', 'answer_index')
