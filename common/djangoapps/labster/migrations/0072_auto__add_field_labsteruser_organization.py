...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("labster_accounts", "0001_initial"),
    )

    def forwards(self, orm):
        # Adding field 'LabsterUser.organization'
        db.add_column('labster_labsteruser', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster_accounts.Organization'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'LabsterUser.organization'
        db.delete_column('labster_labsteruser', 'organization_id')
