...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field problems on 'UserAttempt'
        db.create_table('labster_userattempt_problems', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userattempt', models.ForeignKey(orm['labster.userattempt'], null=False)),
            ('problem', models.ForeignKey(orm['labster.problem'], null=False))
        ))
        db.create_unique('labster_userattempt_problems', ['userattempt_id', 'problem_id'])


    def backwards(self, orm):
        # Removing M2M table for field problems on 'UserAttempt'
        db.delete_table('labster_userattempt_problems')
