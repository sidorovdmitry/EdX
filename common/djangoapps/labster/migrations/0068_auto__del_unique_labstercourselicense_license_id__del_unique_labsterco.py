...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LabsterCourseLicense', fields ['course_id', 'user']
        db.delete_unique('labster_labstercourselicense', ['course_id', 'user_id'])

        # Removing unique constraint on 'LabsterCourseLicense', fields ['license_id']
        db.delete_unique('labster_labstercourselicense', ['license_id'])

        # Adding index on 'LabsterCourseLicense', fields ['license_id']
        db.create_index('labster_labstercourselicense', ['license_id'])

        # Adding unique constraint on 'LabsterCourseLicense', fields ['course_id', 'license_id']
        db.create_unique('labster_labstercourselicense', ['course_id', 'license_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LabsterCourseLicense', fields ['course_id', 'license_id']
        db.delete_unique('labster_labstercourselicense', ['course_id', 'license_id'])

        # Removing index on 'LabsterCourseLicense', fields ['license_id']
        db.delete_index('labster_labstercourselicense', ['license_id'])

        # Adding unique constraint on 'LabsterCourseLicense', fields ['license_id']
        db.create_unique('labster_labstercourselicense', ['license_id'])

        # Adding unique constraint on 'LabsterCourseLicense', fields ['course_id', 'user']
        db.create_unique('labster_labstercourselicense', ['course_id', 'user_id'])
