...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAttempt.is_current_active'
        db.add_column('labster_userattempt', 'is_current_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAttempt.is_current_active'
        db.delete_column('labster_userattempt', 'is_current_active')
