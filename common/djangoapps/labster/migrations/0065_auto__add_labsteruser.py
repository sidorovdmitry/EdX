...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LabsterUser'
        db.create_table('labster_labsteruser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('user_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('user_school_level', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('unique_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, blank=True)),
        ))
        db.send_create_signal('labster', ['LabsterUser'])


    def backwards(self, orm):
        # Deleting model 'LabsterUser'
        db.delete_table('labster_labsteruser')
