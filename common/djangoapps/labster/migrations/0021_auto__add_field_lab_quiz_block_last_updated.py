...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.quiz_block_last_updated'
        db.add_column('labster_lab', 'quiz_block_last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.quiz_block_last_updated'
        db.delete_column('labster_lab', 'quiz_block_last_updated')
