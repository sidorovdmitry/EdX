...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabsterUser.organization_name'
        db.add_column('labster_labsteruser', 'organization_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabsterUser.organization_name'
        db.delete_column('labster_labsteruser', 'organization_name')
