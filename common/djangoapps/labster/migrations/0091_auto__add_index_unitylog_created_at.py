...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UnityLog', fields ['created_at']
        db.create_index('labster_unitylog', ['created_at'])


    def backwards(self, orm):
        # Removing index on 'UnityLog', fields ['created_at']
        db.delete_index('labster_unitylog', ['created_at'])
