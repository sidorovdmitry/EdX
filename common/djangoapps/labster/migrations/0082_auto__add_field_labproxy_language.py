...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabProxy.language'
        db.add_column('labster_labproxy', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=4, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabProxy.language'
        db.delete_column('labster_labproxy', 'language')
