...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Problem.current_conv_popup_id'
        db.add_column('labster_problem', 'current_conv_popup_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Problem.image_id'
        db.add_column('labster_problem', 'image_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Problem.read_more_url'
        db.add_column('labster_problem', 'read_more_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Problem.current_conv_popup_id'
        db.delete_column('labster_problem', 'current_conv_popup_id')

        # Deleting field 'Problem.image_id'
        db.delete_column('labster_problem', 'image_id')

        # Deleting field 'Problem.read_more_url'
        db.delete_column('labster_problem', 'read_more_url')
