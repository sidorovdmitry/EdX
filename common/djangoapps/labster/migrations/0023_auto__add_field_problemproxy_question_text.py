...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemProxy.question_text'
        db.add_column('labster_problemproxy', 'question_text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemProxy.question_text'
        db.delete_column('labster_problemproxy', 'question_text')
