...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAnswer.attempt'
        db.add_column('labster_useranswer', 'attempt',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labster.UserAttempt'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAnswer.attempt'
        db.delete_column('labster_useranswer', 'attempt_id')
