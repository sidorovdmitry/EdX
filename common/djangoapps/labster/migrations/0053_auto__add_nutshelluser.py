...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NutshellUser'
        db.create_table('labster_nutshelluser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('account_id', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('contact_id', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('lead_id', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
        ))
        db.send_create_signal('labster', ['NutshellUser'])


    def backwards(self, orm):
        # Deleting model 'NutshellUser'
        db.delete_table('labster_nutshelluser')
