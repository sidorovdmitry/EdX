...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabsterUser.is_active'
        db.add_column('labster_labsteruser', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabsterUser.is_active'
        db.delete_column('labster_labsteruser', 'is_active')
