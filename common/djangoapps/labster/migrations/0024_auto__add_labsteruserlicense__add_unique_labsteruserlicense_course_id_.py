...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LabsterUserLicense'
        db.create_table('labster_labsteruserlicense', (
        ...
        db.send_create_signal('labster', ['LabsterUserLicense'])

        # Adding unique constraint on 'LabsterUserLicense', fields ['course_id', 'email']
        db.create_unique('labster_labsteruserlicense', ['course_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'LabsterUserLicense', fields ['course_id', 'email']
        db.delete_unique('labster_labsteruserlicense', ['course_id', 'email'])

        # Deleting model 'LabsterUserLicense'
        db.delete_table('labster_labsteruserlicense')
