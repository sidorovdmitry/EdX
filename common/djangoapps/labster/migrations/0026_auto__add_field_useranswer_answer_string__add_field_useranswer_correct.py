...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAnswer.answer_string'
        db.add_column('labster_useranswer', 'answer_string',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'UserAnswer.correct_answer'
        db.add_column('labster_useranswer', 'correct_answer',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'UserAnswer.is_correct'
        db.add_column('labster_useranswer', 'is_correct',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserAnswer.start_time'
        db.add_column('labster_useranswer', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserAnswer.end_time'
        db.add_column('labster_useranswer', 'end_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAnswer.answer_string'
        db.delete_column('labster_useranswer', 'answer_string')

        # Deleting field 'UserAnswer.correct_answer'
        db.delete_column('labster_useranswer', 'correct_answer')

        # Deleting field 'UserAnswer.is_correct'
        db.delete_column('labster_useranswer', 'is_correct')

        # Deleting field 'UserAnswer.start_time'
        db.delete_column('labster_useranswer', 'start_time')

        # Deleting field 'UserAnswer.end_time'
        db.delete_column('labster_useranswer', 'end_time')
