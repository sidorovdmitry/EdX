...
def _section_membership(course_key, access):
    ...
    section_data = {
        ...
        'section_display_name': _('Students and Teachers'),
        'access': access,
...
def _section_data_download(course_key, access):
    ...
    section_data = {
        ...
        'student_quiz_detail_csv_url': reverse('student_quiz_detail_csv', kwargs={'course_id': course_key.to_deprecated_string()}),
    }
    return section_data
