...
from xmodule_django.models import OpaqueKeyField, CourseKeyField, UsageKeyField  # pylint: disable=import-error
...
class LicensedCoursewareItems(models.Model):
    ...
    """
    course_id = CourseKeyField(max_length=255, db_index=True, help_text="Block's parent course locator.")
    ...
    class Meta:
        unique_together = ("course_id", "block")
